          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="inline-block px-4 py-1.5 bg-primary rounded-full text-sm font-medium mb-2">
                  Coming Soon
                </div>
              ...
              {[
                ...
                <div key={index} className="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200">
                  ...
                  <div className="p-6">
                    ...
                    <div className="inline-block px-3 py-1 bg-primary rounded-full text-xs font-medium">
                      Coming Soon
                    </div>
                  </div>
                </div>
